...
},
{
    ...
    texto1: "A escala mais famosa da viola é a escala de Dó maior, isso porque ela não contem ecidentes o que a torna apropriada para iniciante",
    imagem: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcR8cgs5paYi2BoPl9sBkHsQpshtaUSOV7UbjA&s",
...
/*Daqui para frente é o quiz */
    const listaDeQuestoes = [
    {
        ...
        alternativaC: "Clave de Percussão",
        alternativaD: "Clave de Dó",
    ...
    {
        pergunta: "Qual tipo de leitura utiliza a sílaba 'TA' para marcar o ritmo?",
        alternativaA: "Leitura métrica",
        alternativaB: "Solfego",
        alternativaC: "Leitura rítmica",
        alternativaD: "Leitura melódica",
        alternativaCorreta: "alternativaC"
    },
    {
        pergunta: "O que é o solfejo?",
    ...
    {
        pergunta: "Qual nota esta na linha 5 da sua clave",
        alternativaA: "Nota Ré",
        alternativaB: "Nota Dó",
        alternativaC: "Nota Sol",
        alternativaD: "Nota Lá",
        alternativaCorreta: "alternativaC"
    },
    {
        pergunta: "Qual a função da ligadura na música?",
        alternativaA: "Separar notas",
        alternativaB: "Diminuir a duração",
        alternativaC: "Unir duas ou mais notas em um único som",
        alternativaD: "Mudar o compasso",
        alternativaCorreta: "alternativaC"
    },
    {
        pergunta: "Qual é a escala mais famosa do seu instrumento citada no curso?",
        alternativaA: "Escala de Ré Maior",
        alternativaB: "Escala de Sol Maior",
        alternativaC: "Escala de Lá Maior",
        alternativaD: "Escala de Dó Maior",
        alternativaCorreta: "alternativaD"
    },
    ]
